...
export function convertGoogleCalendarEvent(event: Calendar.Schema$Event): CalendarEvent {
	return {
		id: event.id || "",
...
export function convertCalendarEvent(calendarEvent: CalendarEventTemplate): Calendar.Schema$Event {
	return {
